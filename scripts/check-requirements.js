...
if (!process.version.startsWith("v" + version + ".")) {
  console.log("ERROR: Clob requires node version " + version + ", but your version is " + process.version + ".\n");
  console.log("Please switch to the required node version and install clob again.\n");
